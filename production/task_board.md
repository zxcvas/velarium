...
Use this format for active items:
- [ ] Short task title — Owner: @subagent-coder — Files: src/...
- Add notes underneath when work begins.

When a task is complete, move to "Done this cycle" section or just mark [x] and archive context in dev diary later.
